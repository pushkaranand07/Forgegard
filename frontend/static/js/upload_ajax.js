    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.output === 'REAL') {
            ...
            barClass = 'bg-success';
        } else if (data.output === 'FAKE') {
            badgeClass = 'text-danger';
            barClass = 'bg-danger';
        }

        const confidence = Number(data.confidence_pct || 0);
            ...
            <div class="card-body">
              ...
              <div class="mt-3">
                ...
                <div class="progress mt-2" style="height: 14px;">
                  <div class="progress-bar ${barClass} progress-bar-striped progress-bar-animated" style="width: ${pctWidth}%"></div>
                </div>
              </div>
            </div>
          </div>
